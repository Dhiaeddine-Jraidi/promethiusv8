...
model_path = 'ml/model_alpha.pkl'
encode_csv_path = 'ml/encoder_data.csv'
...
def decode_dict_features(input_dict, encoder_data):
    ...
    for key, value in input_dict.items():
        if isinstance(value, (float,int)):  # Check if value is an object
...
def predict_probability(dict):
    ...
    dict['take_profit_percent'] = dict['take_profit_percent'] / 100
    dict['stop_loss_percent'] = dict['stop_loss_percent'] / 100
